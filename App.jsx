      ...
      <section id="services" className="py-24 relative bg-gradient-to-b from-black to-zinc-950">
        <div className="container mx-auto px-6 max-w-[1600px]">
          <div className="mb-20 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Our Consultancy and Training Ecosystem</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-400 max-w-sm mb-6">
                ...
                Your premier partner for customised training. We empower organizations through comprehensive solutions in Automotive Excellence, Soft Skills, and IT Skills.
              </p>
            </div>
